...
$upgRiskClassOption = array();
$upgRiskClassOption[] = JHtml::_('select.option', 'na', vmText::_('VMPAYMENT_UPG_PAYCO_DEFAULT_RISKCLASS_NONE'));
$upgRiskClassOption[] = JHtml::_('select.option', '0', vmText::_('VMPAYMENT_UPG_PAYCO_DEFAULT_RISKCLASS_TRUSTED'));
$upgRiskClassOption[] = JHtml::_('select.option', '1', vmText::_('VMPAYMENT_UPG_PAYCO_DEFAULT_RISKCLASS_DEFAULT'));
$upgRiskClassOption[] = JHtml::_('select.option', '2', vmText::_('VMPAYMENT_UPG_PAYCO_DEFAULT_RISKCLASS_HIGH'));
?>
...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<fieldset>
		...
		<?php if($this->shoppergroup->virtuemart_shoppergroup_id > 0): ?>
		<?php echo VmHTML::row('select','VMCUSTOM_RISKCLASSPRODUCT_FORMLABEL', 'upg_riskclass', $upgRiskClassOption ,$this->shoppergroup->upg_riskclass,'','value', 'text',false) ; ?>
		<?php endif; ?>
		<?php /*
		  <tr>
