...
<div class="post_payment_payment_name" style="width: 100%">
	<span class="post_payment_payment_name_title" data-payment-method="<?php echo  $viewData["payment_code"]; ?>"><?php echo vmText::_ ('VMPAYMENT_STANDARD_PAYMENT_INFO'); ?></span>
...
<div class="post_payment_order_number" style="width: 100%">
	...
	<span class="ordernumber"><?php echo $viewData["order_number"]; ?></span>
</div>
